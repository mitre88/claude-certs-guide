...
export async function generateMetadata({
  ...
  const S = t(lang);
  return c ? { title: S.practice.metaTitle(c.code), description: S.practice.metaDescription(c.name) } : {};
}

export default async function PracticePage({ params }: { params: Promise<{ lang: string; code: string }> }) {
